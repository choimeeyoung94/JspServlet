...
<body>
  ...
  <%--
    ...
    3. 내장 객체
       ...
       4) application   javax.servlet.jsp.ServletContext         applicationScope
    ...
    4. 주요 객체 주의사항
       1) config    : JSP 페이지 초기화 파라미터 등에 접근할때 사용할 수 있으나, 일반적으로 거의 사용 안함
       2) page      : JSP가 서블릿으로 변환되었을 때 현재 서블릿 인스턴스 자신을 읨하나, 거의 사용 안함 (this와 동일하기 때문)
       3) exception : 에러 페이지이서만 사용 가능(<%@ page isErrorPage="true" %> 지시어가 있어야 사용 가능)
